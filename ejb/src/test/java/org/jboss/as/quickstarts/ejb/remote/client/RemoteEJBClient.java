...
//        return (RemoteCalculator) context.lookup("ejb:" + appName + "/" + moduleName + "/" + distinctName + "/" + beanName + "!" + viewClassName);
        return (RemoteCalculator) context.lookup("ejb/CalculatorBean!org.jboss.as.quickstarts.ejb.remote.stateless.RemoteCalculator");
    }
...
//        return (RemoteCounter) context.lookup("ejb:" + appName + "/" + moduleName + "/" + distinctName + "/" + beanName + "!" + viewClassName + "?stateful");
        return (RemoteCounter) context.lookup("ejb/CounterBean!org.jboss.as.quickstarts.ejb.remote.stateful.RemoteCounter");
    }
}